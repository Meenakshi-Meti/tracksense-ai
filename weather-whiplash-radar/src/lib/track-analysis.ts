...
/**
 * Frontend stand-in for the vision model: samples the image on a canvas and
 * derives a wetness index from darkness + specular highlight contrast
 * (wet asphalt is darker with bright reflections). Swap for the API call later.
 */
